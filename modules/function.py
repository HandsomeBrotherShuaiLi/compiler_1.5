...
def FreeReg(codes):#释放寄存器占用
    ...
    for key in Regs:
        if Regs[key]==freed:
            for item in SymbolTable:
                if item.place==freed:
                    Mips.append('addi $1,$0,0x{}'.format(DataSegment))
                    Mips.append('sw {},{}($1)'.format(key,item.offset))
                    Regs[key] = ''
...
def GenerateMips(codes):#翻译中间代码为MIPS
    ...
    # Mips.append("addiu $sp,$0,0x{}".format(DataSegment+StackOffset))
    # Mips.append("or $fp,$sp,$0")
    while len(remain)>0:
        ...
        if code[0] == ':=':
            ...
            Mips.append('add {},$0,{}'.format(arg1, arg3))
        elif code[1] == ':':
            if code[0][0]=='f':
                Mips.append('')
            ...
            if code[3]=='ra':
                ...
                if str(reg)[0] != '$':
                    Mips.append("add $a0,$0,{}".format(reg))
                    reg = '$a0'
            ...
            Mips.append('bgt {},$0,{}'.format(arg1, code[3]))
        elif code[0] == 'return':
            Mips.append('jr $ra')
        else:
            if code[0]=='+':
                if code[1]=='fp':
                    ...
                    if str(arg1)[0]!='$':
                        Mips.append("add $a1,$0,{}".format(arg1))
                        arg1 = '$a1'
                ...
                if code[1]=='fp':
                    ...
                    if str(arg1)[0]!='$':
                        ...
                        arg1='$a1'
                    if str(arg2)[0]!='$':
                        Mips.append("add $a2,$0,{}".format(arg2))
                        arg2 = '$a2'
...
if __name__=="__main__":
    MIPS('S:\pycharm\compiler_1.5\\test2.c')
